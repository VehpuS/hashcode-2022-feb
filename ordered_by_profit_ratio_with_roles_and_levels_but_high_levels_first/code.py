...
def proj_profit_key_with_roles_and_levels_but_high_lvls_first(proj_dict, proj):
...
def ordered_by_profit_ratio_with_roles_and_levels_but_high_lvls_first(input_path):
    ...
    sorted_proj.sort(
        key=lambda proj: proj_profit_key_with_roles_and_levels_but_high_lvls_first(proj_dict, proj))
    sorted_proj.reverse()
...
for tf in test_files:
    a_dic, a_ord = ordered_by_profit_ratio_with_roles_and_levels_but_high_lvls_first(
        tf)
